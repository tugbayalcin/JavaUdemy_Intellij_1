package Section10_Abstract_Interface_Inner.InnerClass;
...
class SarmalayiciClass // dıstaki classim olustu
{
    ...
    public static void SarmalayiciClassMethodu()
    {
        ...
        SarmalayiciClass.InnerClass innerclassobjesi = sarmalayici.new InnerClass(); // dis class nesnesini kullanarak static olmayan ic classtan bir nesne urettim
        ...
        SarmalayiciClass.StaticInnerClass staticInnerClassNesnesi = new SarmalayiciClass.StaticInnerClass();
